(ns kuti.dispatch-test
  (:require [clojure.data]
            [clojure.test :refer :all]
            [kuti.dispatch :as sut]
            [kuti.fixtures.dispatch-fixtures :as green-truck-handler]
            [kuti.fixtures.dispatch-fixtures :as first-handler]
            [kuti.fixtures.dispatch-fixtures :as second-handler]))
